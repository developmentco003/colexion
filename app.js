...
app.get('/latestupdates', isLoggedIn, (req,res)=>{
  res.render('latest', {data: ''})
})



app.get('/enter', isLoggedIn, (req,res)=>{
  res.render('enter',{data:''})
})

app.get('/wait', isLoggedIn, (req,res)=>{
  res.render('waitlist',{data:''})
})

app.get('/staytune', isLoggedIn, (req,res)=>{
  res.render('staytune',{data:''})
})

app.get('/ads', isLoggedIn, (req,res)=>{
  res.render('ad', {data: ''})
})
...
app.get('/shopby', isLoggedIn,  (req,res)=>{
  res.render('shopby',{data:''})
})
